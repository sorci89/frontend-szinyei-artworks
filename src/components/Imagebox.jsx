...
const Imagebox = (props) => {
  ...
  const savePicture = async () => {
    try {
      const response = await axios.post(
        "http://ec2-3-121-180-63.eu-central-1.compute.amazonaws.com:3101/api/picture/save",
        { data: savedImage },
        {
          headers: {
  ...
  const deletePicture = async (id) => {
    try {
      const response = await axios.post(
        "http://ec2-3-121-180-63.eu-central-1.compute.amazonaws.com:3101/api/picture/delete",
        { data: id },
        {
          headers: {
            Authorization: localStorage.getItem("SessionID"),
